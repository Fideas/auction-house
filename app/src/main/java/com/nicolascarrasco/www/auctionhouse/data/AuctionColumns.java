...
public interface AuctionColumns {
    ...
    @DataType(DataType.Type.TEXT) @NotNull String AUCTION_OWNER = "auction_owner";
    ...
    @DataType(DataType.Type.INTEGER) @DefaultValue("0") String PRICE = "price";
    @DataType(DataType.Type.INTEGER) @NotNull String EXPIRATION_DATE = "expiration_date";
    @DataType(DataType.Type.TEXT) String CURRENT_BIDDER = "current_bidder";
    @DataType(DataType.Type.INTEGER) @NotNull String IS_ACTIVE = "is_active"; //Used as a BOOLEAN
}
